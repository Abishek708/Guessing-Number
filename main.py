...
def basic():
    ...
    # footer 
    footer = Label(text='Developed by Abishek', font="Helvicta 8 bold",
...
def result():
    ...
    if number == '':
        ...
        if count == 10:
            ...
            tmsg.showinfo('RETRY', f'Select greater number')
        else:
            tmsg.showinfo('RETRY', f'Select smaller number')
...
def call1():
    str1 = 'This game is developed by ABISHEK A'
...
l = Label(image=img).pack(pady=20)
i = Image.open('bt.png')
resized_image = i.resize((100, 150), Image.LANCZOS)
